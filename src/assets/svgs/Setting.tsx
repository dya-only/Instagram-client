export default function Setting () {
  return (
    <svg aria-label="옵션" className="x1lliihq x1n2onr6 cursor-pointer" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>옵션</title>
